...
class MigrationStep(migrations.AbstarctMigrationStep):
    ...
    def upgrade(self, session):
        sql_expressions = [
            ...
            CREATE OR REPLACE VIEW ua_outdated_master_hash_resources_view AS
                ...
                WHERE ua_target_resources.master_hash != masters.hash;
            """,
            """
            CREATE OR REPLACE VIEW ua_outdated_master_full_hash_resources_view AS
                ...
                FROM ua_target_resources JOIN ua_target_resources as masters ON 
                    ua_target_resources.master = masters.uuid
                WHERE ua_target_resources.master_full_hash != masters.full_hash;
            """,
        ]
    ...
    def downgrade(self, session):
        sql_types = [
            "ALTER TABLE ua_target_resources DROP COLUMN master_hash;",
            "ALTER TABLE ua_target_resources DROP COLUMN master_full_hash;",
            "DROP INDEX ua_target_resources_hash_idx;",
            "DROP INDEX ua_target_resources_full_hash_idx;",
            "DROP INDEX ua_target_resources_master_hash_idx;",
            "DROP INDEX ua_target_resources_master_full_hash_idx;",
        ]
