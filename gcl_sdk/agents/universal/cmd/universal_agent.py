...
def load_driver(
    class_: tp.Type[driver_base.AbstractAgentDriver],
) -> driver_base.AbstractAgentDriver:
...
def main():
    ...
    drivers = []
    capabilities = set()
    for driver_name in CONF[DOMAIN].drivers or tuple():
